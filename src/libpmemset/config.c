 ...
 */
int
pmemset_config_set_create_if_none(struct pmemset_config *config, int value)
{
 ...
 */
int
pmemset_config_set_create_if_invalid(struct pmemset_config *config, int value)
{
	return PMEMSET_E_NOSUPP;
}
 ...
 */
int
pmemset_config_set_contiguous_part_coalescing(struct pmemset_config *config,
		int value)
{
	return PMEMSET_E_NOSUPP;
}
 ...
 */
int
pmemset_config_set_layout_nameU(struct pmemset_config *config,
		const char *layout)
{
	return PMEMSET_E_NOSUPP;
}
 ...
 */
int
pmemset_config_set_layout_nameW(struct pmemset_config *config,
